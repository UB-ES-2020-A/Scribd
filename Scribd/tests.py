...
class EbookTestCase(TestCase):
    def setUp(self):
        Ebook.objects.create(name="Don Quijote", autor="Miguel de Cervantes", description="", is_promot=False,size=2,media_type="pdf")

    def test_ebook_can_create(self):
        quijote = Ebook.objects.get(name="Don Quijote")
