    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_photo',
                 models.ImageField(default='scribd/static/images/', upload_to='scribd/static/images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.BooleanField()),
                ('type', models.CharField(choices=[('admin', 'admin'), ('provider', 'provider'), ('support', 'support'),
                                                   ('free_trial', 'free_trial'), ('subscribed', 'subscribed')],
                                          max_length=15)),
            ],
            options={
                'verbose_name': 'User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_stars', models.CharField(
                    choices=[('One star', 1), ('Two stars', 2), ('Three stars', 3), ('Four stars', 4),
                             ('Five stars', 5)], max_length=12)),
