...
urlpatterns = [
    ...
    url('userprofile/(?P<username>\w+)/$', user_profile_page.as_view(), name='userprofilepage'),
    url('userprofile/(?P<username>\w+)/edit/$', edit_profile_page, name='edituserprofile'),
    url('userprofile/(?P<username>\w+)/upgrade/$', upgrade_account_view, name='upgradeaccount'),
